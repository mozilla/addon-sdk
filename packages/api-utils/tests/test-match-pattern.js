...
exports.testMatchPatternTestTrue = function(test) {
  ...
  ok(new RegExp("http[s]?:\\/\\/bugzilla\\..*\\/.*"), "https://bugzilla.redhat.com/show_bug.cgi?id=569753");
  ok(new RegExp("http[s]?:\\/\\/bugzilla\\..*\\/.*"), "https://bugzilla.mozilla.org/show_bug.cgi?id=627386");
};
