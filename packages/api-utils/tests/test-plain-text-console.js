...
exports.testPlainTextConsole = function(test) {
  ...
  test.assertEqual(lastPrint(), "info: api-utils: testing 1 2,3,4\n",
  ...
  test.assertEqual(tbLines[0], "info: api-utils: Traceback (most recent call last):");
