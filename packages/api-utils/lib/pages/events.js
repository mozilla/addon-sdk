...
/**
 * @examples
 * // Alert whenever any page location changes.
 * require('api-utils/pages/events').navigate(function(event) {
 *    // event target will be a remote browser in which event occured.
 *    event.target.messageManager.loadFrameScript('data:,dump("hello world)');
 * })
 */
