...
// Extracts `tab` element from tab event.
exports.tab = function tab(event) event.originalTarget

// Extracts unique id for the given tab. If such id does not exists assigns one
// and than returns.
exports.id = function id(tab) {
  let value = tab.getAttribute(ID)
