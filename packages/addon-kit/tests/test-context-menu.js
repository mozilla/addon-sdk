...
exports.testContentContextMatch = function (test) {
  ...
  let item = new loader.cm.Item({
    label: "item",
    contentScript: 'self.port.on("context", function () true);'
  });
...
exports.testContentContextNoMatch = function (test) {
  ...
  let item = new loader.cm.Item({
    label: "item",
    contentScript: 'self.port.on("context", function () false);'
  });
...
exports.testContentContextArgs = function (test) {
  ...
  let item = new loader.cm.Item({
    label: "item",
    contentScript: 'self.port.on("context", function (node) {' +
...
exports.testMultipleContexts = function (test) {
  ...
  let item = new loader.cm.Item({
    ...
    contentScript: 'self.port.on("context", function () postMessage());',
    onMessage: function () {
...
exports.testItemClick = function (test) {
  ...
  let item = new loader.cm.Item({
    label: "item",
    data: "item data",
    contentScript: 'self.port.on("click", function (node, data) {' +
                   '  let Ci = Components.interfaces;' +
                   '  postMessage({' +
