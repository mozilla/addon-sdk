...
exports.testConstructor = function(test) {
  ...
  function testSingleWidget(widgetOptions) {
    // We had to display which test is runned, because here we do not 
    // use regular test framework but use a custom one that iterate of 
    // `tests` array.
    // (console.info doesn't display anything except being in verbose mode)
