...
exports["test indexed"] = assert => {
  let { loader, messages } = LoaderWithHookedConsole(module);
  let { Indexed } = loader.require("sdk/model/indexed");

  let XS = function() {}
  XS.prototype = Object.create(Indexed.prototype)
...
exports["test for of iteration"] = assert => {
  let { Indexed } = require("sdk/model/indexed");
