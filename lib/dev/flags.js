 ...
 *   - probably in gDevTools, create a map from legal componentIDs to
 *     the flags that can be overriden on these components
...
function Flags({componentIDs, callback}) {
	...
	componentIDs.forEach(componentID => {
		gDevTools.setAddonFlagsCallback(componentID, callback);
	});
}
exports.Flags = Flags;
