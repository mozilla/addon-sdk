...
function Debuggee(id, connection, client) {
  this.connection = connection;
  this.client = client;
  this.id = id;
  this.location = new URL(connection.url);
}
...
function registerPane(pane) {
  gDevTools.registerTool({
    ...
    build: function(window, toolbox) {
      ...
      const debuggee = new Debuggee(getOuterId(toolbox.target.window),
                                    toolbox.target.form,
                                    toolbox.target.client);
