...
const { Cc, Ci, Cr } = require('chrome'),
      ...
      { windowNS, rawWindowNS } = require('../window/namespace'),
      { getRawWindow } = require('../window/internals'),
...
const BrowserWindowTrait = Trait.compose(
  ...
  Trait.compose({
    ...
    constructor: function BrowserWindow(options) {
      ...
      rawWindowNS(this._window).window = this._public;
      getOwnerWindow.implement(this._public, getRawWindow);
    ...
    _onUnload: function() {
      ...
      rawWindowNS(this._window).window = null;
