...
let { deprecateFunction } = require("../util/deprecate");
 ...
 *    for a detailed explanation.
 */
function off(element, type, listener, capture) {
  element.removeEventListener(type, listener, capture);
}
exports.off = off
exports.removeListener = deprecateFunction(off,
  "`removeListener` is deprecadet please use `off` instead");
