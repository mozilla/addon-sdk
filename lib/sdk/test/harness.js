...
function cleanup() {
  ...
  require("../timers").setTimeout(showResults, 1);
}
...
function nextIteration(tests) {
  ...
  if (iterationsLeft && (!stopOnError || results.failed == 0)) {
    ...
    require("../deprecated/unit-test").findAndRunTests({
    ...
    require("../timers").setTimeout(cleanup, 0);
  }
}
...
var runTests = exports.runTests = function runTests(options) {
  ...
  try {
    ...
    var ptc = require("../console/plain-text");
    ...
    print(require("../console/traceback").format(e) + "\n" + e + "\n");
