...
attach.define(Worker, function (worker, window) {
  ...
  WorkerSandbox(worker, model.window).init.then(contentWorker => {

    // will set model.contentWorker pointing to the private API:
    model.contentWorker = contentWorker;
    ...
    try {
      ...
      console.error('WARN: window already destroyed before attaching ContentWorker');
    }
