...
attach.define(Worker, function (worker, window) {
  ...
  observers.add("inner-window-destroyed", model.documentUnload);
...
detach.define(Worker, function (worker) {
  ...
  if (model.windowID) {
    model.windowID = null;
    observers.remove("inner-window-destroyed", model.documentUnload);
 ...
 */
function documentUnload (subject, topic, data) {
  let model = modelFor(this);
