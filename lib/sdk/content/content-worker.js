  ...
  injectTimers: function injectTimers(exports, chromeAPI, pipe, console) {
    ...
    function registerTimer(timer) {
      ...
      if (typeof timer.fun == 'string') {
        // instead of escaping the code and splicing it, get a reference 
        // to a Function constructor from the sandbox, and call it directly
        let SandboxedFunction = chromeAPI.sandbox.evaluate(exports, 'Function');
        timer.fun = new SandboxedFunction(timer.fun);
