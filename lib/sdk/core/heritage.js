...
/**
 * The function unbind takes an argument of the form obj.fun, where obj is an
 * object and fun is a function, and returns a function. When this function is
 * called with arguments arg1, arg2, ..., argn, it calls fun with obj as the
 * this parameter and arg1, arg2, ..., argn as the arguments. That is:
 *
 * unbind(obj.foo)(arg1, arg2, ..., argn) -> obj.foo(arg1, arg2, ..., argn)
 */
