  ...
  var deferred = {
    ...
    resolve: function resolve(value) {
      if (!result) {
        ...
        // If it's the end of the chain and the user has specified an
        // `_unhandledError` callback, register it as the rejection handler.
        else if (exports._unhandledError) {
          result.then(function(){}, exports._unhandledError);
        }
