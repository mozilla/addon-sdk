...
function onFocus(window) {
  ...
  if (focused) {
    ...
    childTargetWindow.addEventListener("focus", function focusListener() {
      ...
      // In order to save from various errors, we delay the focus resolution.
      // If you try to focus another window in the same iteration of the event
      // loop, the focused window won't change.
