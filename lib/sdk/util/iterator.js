...
let { iteratorSymbol } = require("./iteration");
...
Iterator.prototype = Object.create(base, {
  length: { get: method(count) },
  iterator: { value: _ => { throw TypeError("Iterator instance must implement " +
...
Iterator.prototype[iteratorSymbol] = function*(...args) {
