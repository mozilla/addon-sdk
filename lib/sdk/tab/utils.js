...
const { compose, constant } = require("../lang/functional");
...
const { mapcat } = require("../util/sequence");
...
isTabOpen.where(isXULTab, compose(Boolean, field("linkedBrowser")));
isTabOpen.where(isFennecTab, compose(Boolean, getOwnerWindow));
...
getBrowserFor.where(isFennecTab, field("browser"));
getBrowserFor.where(isXULTab, field("linkedBrowser"));
