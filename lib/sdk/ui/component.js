...
Component.write = component => {
  if (!(component instanceof Component)) {
    return Object.assign({}, component, {
      children: component.children && component.children.map(Component.write)
    })
  }
  ...
  if (isUpdated(current, pending)) {
    ...
    component[cache] = Component.write(render(component[currentState]));

    if (Component.isMounted(component)) {
      const write = component[writer];
