...
const Sandbox = Class({
  ...
  initialize: function(target, options) {
    ...
    setImmediate(_ => {
      try {
        this._sandbox = sandbox(target, options);
        resolve(this);
      } catch (e) {
        reject(e);
      }
  ...
  load: function(uri) {
    return this.init.then(_ => load(this._sandbox, uri));
  },

  evaluate: function(code, uri, line, version) {
    return this.init.then(_ => evaluate(this._sandbox, code, uri, line, version));
  },

  nuke: function() {
    return this.init.then(_ => Cu.nukeSandbox(this._sandbox));
  },
