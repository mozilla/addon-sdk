 ...
 * module given. If not, an exception is raised.
 *
 * @param {Object} module
 *  The module to check
 */
function satisfies(module) {
  ...
  if (engines === null || typeof engines !== "object")
    throw new Error("Malformed engines' property in metadata");
  ...
  if (typeof versionRange === "string") {
    ...
    throw new Error("Unsupported Application version: The module " + id +
            " currently supports only version " + versionRange + " of " +
            xulappModule.name + ".");
  }

  throw new Error("Unsupported Application: The module " + id +
...
function CuddlefishLoader(options) {
  ...
  options = override(options, {
    ...
    load: function(loader, module) {
      ...
      // incompatibility. Therefore the exception is stored, and throws again
