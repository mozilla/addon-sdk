...
const TabType = Class({
  ...
  setup: function setup(options) {
    ...
    */
    ...
    browser.addEventListener(EVENTS.ready.dom, this, true);
  ...
  dispose: function dispose() {
    ...
    let view = getView(this);
    let browser = getBrowserForTab(view);
    browser.removeEventListener(EVENTS.ready.dom, this, true);
  ...
  attach: function attach(options) {
    ...
    return Worker(options, getContentDocument(view).defaultView);
  },
  close: function(callback) {
    if (callback) this.once(EVENTS.close.name, callback);
    close(tab(this).view);
  }
});
