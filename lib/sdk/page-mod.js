...
const PageMod = Loader.compose(EventEmitter, {
  ...
  _applyOnExistingDocuments: function _applyOnExistingDocuments() {
    ...
    function applyToTabWindow(window) {
    ...
    tabs.forEach(function (tab) {
      ...
      applyToTabWindow(getTabContentWindow(tab));
  ...
  _onContent: function _onContent(window) {
    ...
    if (this._seenWindows.has(window.document)) 
      return;
    this._seenWindows.set(window.document, true);
    ...
    if (!this.include.matchesAny(window.location.href))
      return;
