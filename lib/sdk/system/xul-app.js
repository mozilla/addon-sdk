...
try {
  ...
  if (e.message !== "Bootstrap sandbox `require` method isn't implemented.")
    throw e;
...
function compareVersion(version, comparison, compareVersion) {
  ...
  if (typeof compareVersion === "undefined")
    return true;
...
function satisfiesVersion(version, versionRange) {
  ...
  return ranges.some(function(range) {
    ...
    return compareVersion(version, lowMod, lowVer) && compareVersion(version, highMod, highVer);
  });
}
