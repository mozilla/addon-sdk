...
const { exit, staticArgs } = require('../system');
const { when: unload } = require('../system/unload');
const { loadReason, loadCommand } = require('../self');
...
function startup(reason, options) {
  ...
  require('../l10n/loader').
    load(rootURI).
    catch(e => console.info("Error while loading localization: " + e.message)).
