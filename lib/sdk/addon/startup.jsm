...
// NOTE: This file is meant to be used by sdk/addon/runner,
// and the bootstrap file of any add-on which will load sdk/addon/runner
// See Bug 1042239 https://bugzilla.mozilla.org/show_bug.cgi?id=1042239
...
const { XulApp } = Cu.import(__URI__.replace("addon/startup.jsm", "system/xul-app.jsm"), {});
...
Startup.onceInitialized = gOnceInitializedDeferred.promise;
