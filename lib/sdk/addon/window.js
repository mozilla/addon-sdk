...
eventTarget.addEventListener("DOMContentLoaded", function handler(event) {
  docShell.currentDocumentChannel.originalURI = newURI(baseURI + "index.html",
                                                       null,
                                                       null);
  window.document.documentElement.setAttributeNS("http://www.w3.org/XML/1998/namespace",
                                                 "base",
                                                 baseURI + "index.html");
