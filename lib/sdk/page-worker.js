...
const Page = Class({
  ...
  setup: function Page(options) {
    ...
    // Can't seem to get frame's load event via global window
//    view.addEventListener('load', function (e) { console.log(e.target, e.type); }, true);
    views.set(this, view);
    pages.set(view, this);
 ...
 * out private windows
 */
let pageEvents = filter(function({type, target}) {
