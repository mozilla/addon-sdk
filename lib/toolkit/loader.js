...
try {
  MIN_DELAY = prefBranch.getIntPref("dom.min_timeout_value");
} finally {}
...
let setTimeout = setTimer.bind(null, TYPE_ONE_SHOT);
exports.setTimeout = setTimeout;
let setInterval = setTimer.bind(null, TYPE_REPEATING_SLACK);
exports.setInterval = setInterval;

let clearTimeout = unsetTimer.bind(null);
let clearInterval = unsetTimer.bind(null);
...
const Loader = iced(function Loader(options) {
  let { modules, resolve, paths } = override({
    paths: {},
    modules: {},
    resolve: exports.resolve
  }, options);

  let globals = override({
