...
[panels](modules/panel.html) to them that open when they're
...
[`Widget()` constructor](modules/widget.html#Widget(options)).
...
You can supply a [panel](modules/panel.html) to the widget's
...
@param options {object}
  ...
  @prop [panel] {Panel}
    An optional [panel](modules/panel.html) to open when the
...
@param window {BrowserWindow}
  The [BrowserWindow](modules/windows.html) instance to match.
@returns {WidgetView}
...
<api name="panel">
@property {Panel}
  A [panel](modules/panel.html) to open when the user clicks on
  the widget.
</api>
