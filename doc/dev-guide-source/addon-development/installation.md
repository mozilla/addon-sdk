...
<pre>
  ~/mozilla > tar -xf addon-sdk-1.3b2.tar.gz
  ~/mozilla > cd addon-sdk-1.3b2
  ~/mozilla/addon-sdk-1.3b2 >
</pre>

Then run:

<pre>
  ~/mozilla/addon-sdk-1.3b2 > source bin/activate
</pre>
...
<pre>
  C:\Users\mozilla\sdk>7z.exe x addon-sdk-1.3b2.zip
  C:\Users\mozilla\sdk>cd addon-sdk-1.3b2
  C:\Users\mozilla\sdk\addon-sdk-1.3b2>
</pre>

Then run:

<pre>
  C:\Users\mozilla\sdk\addon-sdk-1.3b2>bin\activate
</pre>
