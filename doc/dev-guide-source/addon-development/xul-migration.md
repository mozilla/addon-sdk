...
[`addon-kit`](packages/addon-kit/index.html) package. Because we expect
...
[links to detailed API documentation](packages/addon-kit/index.html).
...
[low-level modules](packages/api-utils/index.html) some of which, such
