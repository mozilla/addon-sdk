...
[events](modules/deprecated/events.html),
[worker](modules/content/worker.html), and
[api-utils](modules/deprecated/api-utils.html). You're more
...
such as [tab-browser](modules/deprecated/tab-browser.html),
[xhr](modules/io/xhr.html), and
