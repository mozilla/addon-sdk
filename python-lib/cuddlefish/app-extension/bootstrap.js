...
exports.startup = function startup(data, reason) {
  ...
  let globals = loader.load('api-utils/@globals');
  ...
  loader.globals.packaging = { jetpackID: options.jetpackID, options: options };
  ...
  observres.add('sessionstore-windows-restored', function() {
    // Load a main module.
